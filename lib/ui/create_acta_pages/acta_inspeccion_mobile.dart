...
class MobileRegisterPage extends StatefulWidget {
  const MobileRegisterPage({Key? key, required this.tipo}) : super(key: key);
  final bool tipo;
  @override
...
class _MobileRegisterPageState extends State<MobileRegisterPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((timeStamp) {
      dynamic lista = Provider.of<ActaState>(context, listen: false)
          .MapOfValue['ACTA']['SELECT_CAMP'];
  ...
  final double fontSizeTextRow = 12;
  var selectPage = 0;
